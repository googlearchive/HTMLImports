...
We are more than happy to accept external contributions to the project in the form of [feedback](https://groups.google.com/forum/?fromgroups=#!forum/polymer-dev), [bug reports](https://github.com/Polymer/HTMLImports/issues), and pull requests.
...
1. Fork the project on github and pull down your copy.
        ...
        git clone git@github.com:username/HTMLImports.git
...
We iterate fast! To avoid potential merge conflicts, it's a good idea to pull from the main project before making a change and submitting a pull request. The easiest way to do this is setup a remote called `upstream` and do a pull before working on a change:
    ...
    cd polymer
    git remote add upstream git://github.com/Polymer/HTMLImports.git
